  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'soft-focus': '0 0 0 3px rgba(99, 102, 241, 0.4)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'gradient-primary': 'linear-gradient(to right, #4f46e5, #6366f1)',
        'gradient-accent': 'linear-gradient(to right, #ec4899, #f472b6)',
        'soft-pattern': 'linear-gradient(135deg, rgba(249,250,251,0.9) 0%, rgba(237,242,247,0.5) 100%)',
      },
      borderWidth: {
        '3': '3px',
        '6': '6px',
